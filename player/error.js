module.exports = (client, error, message, ...args) => {
    switch (error) {
        case 'NotPlaying':
            ...
            break;
        case 'NotConnected':
            message.channel.send(`${client.emotes.error} - You are not connected in any voice channel, join one and try again !`);
            break;
        case 'UnableToJoin':
            message.channel.send(`${client.emotes.error} - I am not able to join your voice channel, please check my permissions, banes. !`);
            break;
